...
const ModCard = ({ guide, index }) => {
    ...
    return (
        <div className='bg-white shadow-md flex items-center sm_md:items-start sm_md:flex-row gap-x-5 gap-y-6 p-4 rounded-lg w-[95vw] sm_md:w-full relative'>
            {/* image */}
            ...
            {/* content */}
            <div className="flex justify-between items-center sm_md:items-center sm_md:text-left text-center sm_md:flex-row w-full relative gap-y-6">
                <div className="flex flex-col gap-y-1">
                    <h1 className="text-xl font-semibold">{guide.username}</h1>
                </div>
                    <div className='flex flex-col justify-center items-end gap-y-2 mr-4'>
                        <button
                        onClick={(e) => {
